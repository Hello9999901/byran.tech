  ...
  return (
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ? "left-5 -bottom-16 -translate-y-1/2"
      ...
      {...props}
    >
      <div className="p-2 border rounded-md border-neutral-600">
...
>(({ className, variant = "default", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-8 w-8 rounded-full border-neutral-700",
        orientation === "horizontal"
          ? "right-5 -bottom-16 -translate-y-1/2"
